          ...
          objectStore.openCursor().onsuccess = function(e) {
               ...
               if(cursor) {
                    ...
                    ConsultationHTML.innerHTML = `  
                         ...
                         <p class="font-weight-bold">Information:  <span class="font-weight-normal">${cursor.value.information}<span></p>
                    `;
                 ...
                 consultations.appendChild(ConsultationHTML);
                    ...
                    if(!consultations.firstChild) {
                        services.textContent = 'Change your visiting hours';
                         ...
                         noSchedule.textContent = 'No appointments yet. Book one today!';
